...
(cl:defmethod cl:initialize-instance :after ((m <SonarArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SonarArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2os_driver-msg:<SonarArray> is deprecated: use p2os_driver-msg:SonarArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SonarArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:header-val is deprecated.  Use p2os_driver-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'ranges_count-val :lambda-list '(m))
(cl:defmethod ranges_count-val ((m <SonarArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:ranges_count-val is deprecated.  Use p2os_driver-msg:ranges_count instead.")
  (ranges_count m))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <SonarArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2os_driver-msg:ranges-val is deprecated.  Use p2os_driver-msg:ranges instead.")
  (ranges m))
